...
| 部件 | 说明 |
|---|---|
| 架构 | 骨架+枝叶：`wiki/history/00-skeleton.md`（分期表+维度互动，唯一承重墙）→ 5 枝叶（10-经济/20-政治治理/30-社会民生/40-对外/50-文化）+ cards/ 事件卡 + data/ 手工数据表 |
...
---
*最后更新：2026-09-12 - 证据准入收紧（每假设日 cap=6 择优 / ach_eligible 标记 / 存量退出诊断队列）*
